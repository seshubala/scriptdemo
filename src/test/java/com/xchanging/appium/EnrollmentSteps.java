...
public class EnrollmentSteps{
	...
	public void givenIHaveEnteredPersonalInformation() throws Exception {
	...
	public void givenIHaveEnteredSecurityQuestions() throws Exception {
	...
	public void givenISkipEnteringCardDetails() throws Exception {
	...
	public void whenIVerifyEmailAndLogin() throws Exception {
	...
	public void thenISuccessfullyFinishEnrolmentProcess() throws Exception {
	...
	public void givenIHaveAlreadyEnroled() throws Exception {
	...
	public void givenIHaveRelaunchedTheApplication() throws Exception {
...
//		driver.launchApp();
	...
	public void whenIEnterPasscode() throws Exception{
	...
	public void thenILoginToTheAppSuccessfully() throws Exception{
	...
	public void launchlogin() throws Exception {
		...
		givenIHaveRelaunchedTheApplication();
		whenIEnterPasscode();
		thenILoginToTheAppSuccessfully();
			
	}
	
	@When("I enter the card details")
	public void whenIEnterTheCardDetails() throws Exception {
	 ...
	 public void thenIShouldBeAbleToAddCardSuccessfully() throws Exception {
